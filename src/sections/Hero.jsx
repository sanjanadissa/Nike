  ...
  return (
    <section
      ...
      <div
        ...
        <h1
          ...
          <br />
          <span className="text-coral-red inline-block pt-6">Nike</span> Shoes
        </h1>
    ...
    mt-20 gap-16"
      ...
      max-xl:py-40 bg-primary bg-hero bg-cover bg-center">
        <img src={bigShoeImg} alt="shoe1" width={610} height={500} className="object-contain 
        relative z-10" />
        ...
        sm:left-[20%] max-sm:px-6">
          {shoes.map((item,index)=>(
            <div key={index}>
              <ShoeCard imgURL={item} changeBigShoeImage={(shoe)=>setbigShoeImg(shoe)} bigShoeImge={bigShoeImg} />
