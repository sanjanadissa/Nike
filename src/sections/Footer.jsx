...
const Footer = () => {
  return (
    <footer className="max-container">
      ...
      flex-wrap max-lg:flex-col sm:items-center">
        <div className="flex flex-col items-start sm:mr-12">
        ...
        <div className="flex flex-1 justify-between lg:gap-10 flex-wrap sm:justify-center ">
      ...
      max-sm:items-center">
        ...
        ">
          <img src={copyrightSign} alt="sign" width={20} height={20} className="rounded-full m-0"/>
